...
namespace cmd  // command
{
  ...
  void add(AVLTree< std::string, EngRusDict >& vector, std::istream& in);
  void remove(AVLTree< std::string, EngRusDict >& vector, std::istream& in);
  void addWords(AVLTree< std::string, EngRusDict >& vector, std::istream& in);
  void removeWords(AVLTree< std::string, EngRusDict >& vector, std::istream& in);
  void getIntersection(AVLTree< std::string, EngRusDict >& vector, std::istream& in);
